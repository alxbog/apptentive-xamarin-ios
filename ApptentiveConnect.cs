namespace ApptentiveConnect {
	...
	interface ATConnect {
		...
		bool Engage (string event, NSDictionary customData, UIViewController viewController);
		...
		bool Engage (string event, NSDictionary customData, NSObject [] extendedData, UIViewController viewController);
		...
		void AddCustomData (NSObject object, string key);
